...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Message', fields ['location']
        db.delete_unique(u'sms_message', ['location_id'])


        # Changing field 'Message.location'
        db.alter_column(u'sms_message', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Location'], null=True))

    def backwards(self, orm):

        # Changing field 'Message.location'
        db.alter_column(u'sms_message', 'location_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.Location'], unique=True, null=True))
        # Adding unique constraint on 'Message', fields ['location']
        db.create_unique(u'sms_message', ['location_id'])
    ...
    models = {
        ...
        u'sms.message': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Location']", 'null': 'True', 'blank': 'True'}),
