...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.moderator'
        db.add_column(u'sms_message', 'moderator',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Moderator'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.moderator'
        db.delete_column(u'sms_message', 'moderator_id')
    ...
    models = {
        ...
        u'sms.message': {
            ...
            'moderator': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.Moderator']", 'null': 'True', 'blank': 'True'}),
